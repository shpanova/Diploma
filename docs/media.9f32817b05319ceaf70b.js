...
function createArticleContent(stroke) {
  var title = stroke.title,
    ...
    cover = stroke.cover;
  console.log('da');
  var cover_media = document.querySelector('.Q_cover_media');
  var tag_media = document.querySelector('.Q_tag_media');
  var note_cover = document.querySelector('.Q_note_cover');
  var time_read = document.querySelector('.Q_time_read');
  var title_media = document.querySelector('.Q_title_media');
  tag_media.innerHTML = tags;
  note_cover.innerHTML = note;
  time_read.innerHTML = time;
  title_media.innerHTML = title;
  cover_media.style.backgroundImage = "url(".concat(cover, ")");
}
var content;
