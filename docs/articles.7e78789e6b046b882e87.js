...
var token = 'patMqZk2Akn5UHWfm.48f5f0966f6908ad92e8c86f092d706c79770163860173f2ebc99e60bc7aa57b';
airtable__WEBPACK_IMPORTED_MODULE_0___default().configure({
  endpointUrl: 'https://api.airtable.com',
  apiKey: token
});
var base = airtable__WEBPACK_IMPORTED_MODULE_0___default().base('appwl7ytcI8w3EdWC');
...
function createArticleContent(stroke) {
  ...
  var tag_white = document.querySelector('.Q_tag_white');
  var title_cover_article = document.querySelector('.Q_title_cover_article');
  var des = document.querySelector('.Q_des');
  var time_read = document.querySelector('.Q_time_read');
  var text1 = document.querySelector('.A_content');
  var note_cover = document.querySelector('.Q_note_cover');
  var photo_article = document.querySelector('.Q_photo_article');
  var about_nomi = document.querySelector('.A_about_nomi');
  ...
  cover_img.style.backgroundImage = "url(".concat(cover, ")");
  photo_article.style.backgroundImage = "url(".concat(photo, ")");
